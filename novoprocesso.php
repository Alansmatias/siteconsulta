<h4 class="h4 col-md-12 text-center text-muted font-weight-bold" style="font-size: 1.2em;">Novo Processo de Licenciamento</h4><br>
	...
	<input type="hidden" name="acao" value="cadastrar">
  	<div class="form-row">
	    ...
	    <div class="col-md-4 mb-3">
	      ...
	      <input type="text" name="cpfcnpj" class="form-control" id="validationCustom02" placeholder="Digite CPF ou CNPJ" value="" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
	      <div class="valid-feedback">
	        Looks good!
	      </div>
	    </div>
	    <div class="col-md-4 mb-3">
	      ...
	      <div class="input-group">
	        <input type="text" name="nomeinteressado" class="form-control" id="validationCustomUsername" placeholder="Nome do interessado" aria-describedby="inputGroupPrepend" required>
